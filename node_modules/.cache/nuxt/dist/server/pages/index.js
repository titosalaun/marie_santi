...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=997e997c&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_vm._ssrNode("<div class=\"content\" data-v-997e997c>","</div>",[_vm._ssrNode("<div class=\"col-left\" data-v-997e997c>","</div>",[_vm._ssrNode("<div class=\"logo\" data-v-997e997c>","</div>",[_c('nuxt-link',{attrs:{"to":"/"}},[_c('svg',{attrs:{"id":"Calque_1","data-name":"Calque 1","xmlns":"http://www.w3.org/2000/svg","viewBox":"0 0 776.86 861.5"}},[_c('path',{attrs:{"d":"M291.29,701.18c0,92.18,68.41,131,165.81,131,112.47,0,162.9-51,162.9-163.49V558.56H444.92C360.86,558.56,291.29,614.22,291.29,701.18ZM151.57,725.53c0-113,68.41-197.69,176.24-208.13V490.15c-84.06-10.43-146.67-87-146.67-179.14,0-133.34,130.44-215.66,280-215.66C622.9,95.35,740,173,747,332.46H611.89c-7-80-60.87-117.1-149-117.1-83.48,0-141.45,38.84-141.45,114.78s55.65,117.11,139.14,117.11H928.43V558.56H755.08c0,266.11-3.47,265,5.8,273.64,8.12,7.54,11.6,5.22,167.55,5.22V945.25c-207.55,0-224.94,5.8-263.21-34.2-22.61-23.77-21.45-74.79-21.45-74.79H622.9c-34.78,86.38-107.83,120.59-203.49,120.59C265.2,956.85,151.57,877.42,151.57,725.53Z","transform":"translate(-151.57 -95.35)"}})])])],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"tools\" data-v-997e997c>","</div>",[_vm._ssrNode("<div"+(_vm._ssrClass("tools-content",{ open: _vm.isTools }))+" data-v-997e997c>","</div>",[_vm._ssrNode("<div data-v-997e997c><label data-v-997e997c>Message</label> <textarea placeholder=\"...\" name=\"tools_message\" id=\"tools_message\" data-v-997e997c>"+_vm._ssrEscape(_vm._s(_vm.tools_message))+"</textarea></div> "),_vm._ssrNode("<div data-v-997e997c>","</div>",[_vm._ssrNode("<label data-v-997e997c>Couleur</label> "),_vm._ssrNode("<div class=\"zoneColorText\" data-v-997e997c>","</div>",[_c('color-picker',{on:{"change":_vm.updateColorText},model:{value:(_vm.tools_color_text),callback:function ($$v) {_vm.tools_color_text=$$v},expression:"tools_color_text"}})],1)],2),_vm._ssrNode(" "),_vm._ssrNode("<div data-v-997e997c>","</div>",[_vm._ssrNode("<label data-v-997e997c>Fond</label> "),_vm._ssrNode("<div class=\"zoneColorBg\" data-v-997e997c>","</div>",[_c('color-picker',{on:{"change":_vm.updateColorBg},model:{value:(_vm.tools_color_bg),callback:function ($$v) {_vm.tools_color_bg=$$v},expression:"tools_color_bg"}})],1)],2),_vm._ssrNode(" <div data-v-997e997c><label data-v-997e997c>"+_vm._ssrEscape("Taille : "+_vm._s(_vm.tools_font_size))+"</label> <input type=\"range\" id=\"tools_font_size\" min=\"10\" max=\"200\""+(_vm._ssrAttr("value",(_vm.tools_font_size)))+" class=\"slider\" data-v-997e997c></div> <div"+(_vm._ssrStyle(null,null, { display: (_vm.isAuthenticated) ? '' : 'none' }))+" data-v-997e997c><label class=\"cursor-pointer\" data-v-997e997c>log-out</label></div>")],2),_vm._ssrNode(" <div class=\"tools-nav\" data-v-997e997c>Paramètres</div>")],2)],2),_vm._ssrNode(" <div"+(_vm._ssrClass("col-content",{ marge: _vm.isTools }))+" data-v-997e997c><div class=\"mesure\" data-v-997e997c><div data-v-997e997c><div data-v-997e997c><div class=\"mesure-val\" data-v-997e997c>"+_vm._ssrEscape(_vm._s(_vm.mesureVal))+"</div><div class=\"indice\" data-v-997e997c>DBA</div></div> <div class=\"mesure-temps\""+(_vm._ssrStyle(null,null, { display: (_vm.isRecord) ? '' : 'none' }))+" data-v-997e997c>"+_vm._ssrEscape("Durée : "+_vm._s(_vm.mesureTps))+"</div></div> <div"+(_vm._ssrStyle(null,null, { display: (_vm.displayRecord) ? '' : 'none' }))+" data-v-997e997c><div data-v-997e997c><button"+(_vm._ssrClass("btRecord",{ 'animate-onWait': !_vm.recordOver }))+" data-v-997e997c>record</button> <div class=\"pt-3 text-sm\" data-v-997e997c>"+_vm._ssrEscape(_vm._s(_vm.displayActiveSound))+"</div></div></div></div> <div id=\"content\" data-v-997e997c></div> <div class=\"col-content-list\" data-v-997e997c><div class=\"item\" data-v-997e997c><div contenteditable=\"true\" class=\"editItem\" data-v-997e997c>"+_vm._ssrEscape(_vm._s(_vm.messageInit))+"</div></div></div> <div data-v-997e997c><div id=\"p5Canvas\" class=\"canvas-area\" data-v-997e997c></div></div></div> "),_vm._ssrNode("<div class=\"col-right\" data-v-997e997c>","</div>",[_vm._ssrNode("<div data-v-997e997c>","</div>",[_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.id_source),expression:"id_source"}],attrs:{"name":"id_source","id":"id_source"},on:{"change":[function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.id_source=$event.target.multiple ? $$selectedVal : $$selectedVal[0]},_vm.selectSource]}},[_c('option',{attrs:{"value":"1"}},[_vm._v(" Micro")]),_vm._v(" "),_c('option',{attrs:{"value":"2"}},[_vm._v(" MP3")])])]),_vm._ssrNode(" <div class=\"cursor-pointer\""+(_vm._ssrStyle(null,null, { display: (_vm.displaySave) ? '' : 'none' }))+" data-v-997e997c>save</div> <div class=\"cursor-pointer\""+(_vm._ssrStyle(null,null, { display: (_vm.displayReset) ? '' : 'none' }))+" data-v-997e997c>reset</div> <div class=\"cursor-pointer\""+(_vm._ssrStyle(null,null, { display: (_vm.displayNew) ? '' : 'none' }))+" data-v-997e997c>new</div>")],2)],2),_vm._ssrNode(" <div id=\"defaultModalFile\" tabindex=\"1\" class=\"modalZone hidden overflow-y-auto overflow-x-hidden bg-mainBg/50 flex fixed right-0 left-0 top-4 z-50 justify-center items-center md:h-full md:inset-0\" data-v-997e997c><div class=\"relative px-6 w-full max-w-2xl h-full md:h-auto\" data-v-997e997c><div class=\"relative bg-mainBg p-6 border\" data-v-997e997c><div class=\"flex justify-between items-start border-b \" data-v-997e997c><h1 data-v-997e997c>Sons</h1> <div data-modal-toggle=\"defaultModalFile\" class=\"bg-transparent ml-auto inline-flex items-center highlight\" data-v-997e997c><svg fill=\"currentColor\" viewBox=\"0 0 20 20\" xmlns=\"http://www.w3.org/2000/svg\" class=\"big cursor-pointer\" data-v-997e997c><path fill-rule=\"evenodd\" d=\"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z\" clip-rule=\"evenodd\" data-v-997e997c></path></svg></div></div> <div data-v-997e997c><div class=\"form-container w-full border-0 p-0\" data-v-997e997c><form method=\"post\" autocomplete=\"off\" data-v-997e997c><div class=\"form-bloc mt-9\" data-v-997e997c><div class=\"col w-full\" data-v-997e997c><div class=\"col-content\" data-v-997e997c><div data-v-997e997c><label class=\"uploadZone-file bt-upload required_field\" data-v-997e997c><span class=\"leading-normal\" data-v-997e997c>Ajouter un mp3</span> <input type=\"file\" id=\"file_media\""+(_vm._ssrAttr("accept",_vm.accept_file))+" class=\"hidden\" data-v-997e997c></label> <div class=\"progress progress-media hidden\" data-v-997e997c><div class=\"progress-title-media\" data-v-997e997c>"+_vm._ssrEscape(_vm._s(_vm.uploadPercentageFile)+"%")+"</div> <div class=\"progress-bar-media\""+(_vm._ssrStyle(null,{ width: _vm.uploadPercentageFile + '%' }, null))+" data-v-997e997c></div></div></div></div></div></div> <div class=\"form-bloc mt-9 flex-col\" data-v-997e997c>"+((!_vm.sounds.length)?("<div data-v-997e997c><div"+(_vm._ssrStyle(null,null, { display: (_vm.isShowLoadingSound) ? '' : 'none' }))+" data-v-997e997c>Chargement des sons...</div> <div"+(_vm._ssrStyle(null,null, { display: (_vm.isShowNoResultSound) ? '' : 'none' }))+" data-v-997e997c>aucun son enregistré</div></div>"):"<!---->")+" "+(_vm._ssrList((_vm.sounds),function(sound,indexSound){return ("<div class=\"cursor-pointer block overflow-hidden w-full mb-3 item\" data-v-997e997c>"+_vm._ssrEscape("\n\t\t\t\t\t\t\t\t  \t\t"+_vm._s(sound.titre)+"\n\t\t\t\t\t\t\t  \t\t")+"</div>")}))+"</div> <div class=\"form-action justify-center\" style=\"justify-content: center\" data-v-997e997c><div data-v-997e997c><button type=\"button\" data-v-997e997c>Annuler</button></div></div></form></div></div></div></div></div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=997e997c&scoped=true&
...
var external_moment_ = __webpack_require__(39);
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    displayVal: function (val) {
      ...
      console.log("val = " + this.tools_font_size);
      this.updateFontSize();
    },
